...
public class CSVLineToTemporalGraphHead extends CSVLineToTemporalElement<TemporalGraphHead> {
  ...
  public TemporalGraphHead map(String csvLine) throws Exception {
    ...
    File file = new File("/shared_folder/gradoop-shared/logger_output/GraphLog.txt");
    
    try {
      FileOutputStream fileOutputStream = new FileOutputStream("/shared_folder/gradoop-shared/logger_output/GraphLog.txt",true);
      PrintStream printStream = new PrintStream(fileOutputStream);
      System.setOut(printStream);

      System.out.println("TaskSlot: "+ getRuntimeContext().getIndexOfThisSubtask() + ", GraphId: " + tokens[0] + " \n");
